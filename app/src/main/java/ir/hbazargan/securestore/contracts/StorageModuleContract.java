...
/**
 * Intermediate layer which stores the given data. Used by SecureStorage.
 *
 * <p>Use custom implementation if the built-in implementations are not enough.</p>
 *
 * @see SharedPreferencesStorageModuleImplementation
 */
public interface StorageModuleContract {
