 ...
 * This is not the same as {@link SerializerModuleContract}. This interface is only used to convert the intermediate value
 * into String or vice-versa to be used for {@link StorageModuleContract}
 *
 * <p>Use custom implementation if built-in implementation is not enough.</p>
 *
 * @see GsonParserModuleImplementation
 */
public interface ParserModuleContract {
