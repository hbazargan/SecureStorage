package ir.hbazargan.securestore.serializer;
...
public final class SecureStorageSerializer implements Serializer {
  ...
  public SecureStorageSerializer(LogInterceptor logInterceptor) {
  ...
  public DataInfo deserialize(String serializedText) {
    ...
    if (firstElement != null && firstElement.length() != 0) {
      try {
        ...
        logInterceptor.onLog("SecureStorageSerializer -> " + e.getMessage());
      }
    }
